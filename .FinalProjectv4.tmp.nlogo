...
circle-stack current-rule circle-turtle-stack]
...
to step-through
  ...
  [ let operandA pop-stack "evaluation-stack"
    ...
    choose-draw-operator-model expression_item evaluation
...
to choose-draw-operator-model [expression_item evaluation]
  ...
  [ push-stack evaluation "circle-stack"
    draw-circle-or-square circle-stack "circle"
  ]
  if Model_Chooser = "Concentric Squares"
  [ push-stack evaluation "circle-stack"
    draw-circle-or-square circle-stack "square 2"
  ]

end

to choose-draw-operand-model [expression_item]
  if Model_Chooser = "Tree" [make-turtle 3 expression_item]
end
...
;; concentric circles
to draw-circle-or-square [circle-label model-shape]
  make-circle-model circle-label model-shape
end


to make-circle-model [local-circle-stack model-shape]
  kill-turtles-in-stack local-circle-stack
