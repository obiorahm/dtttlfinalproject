globals [expressions postfix_expression stack]
...
to make-postfix-expression [expression]
  ...
  [if is-an-operator expression_item
...
to push-operator-stack [new-stack-item]
  set stack sentence stack new-stack-item
end
...
to-report test-precedence [operator1 operator2]
  report get-precedence operator1 > get-precedence operator2
end
@#$#@#$#@
GRAPHICS-WINDOW
472
